...
public class MainActivity extends AppCompatActivity{
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setQueryHint("Buscar Refri...");
    ...
    public void getPets(){
        ...
        Call<List<Refri>> call = apiInterface.getPets();
        call.enqueue(new Callback<List<Refri>>() {
            @Override
            public void onResponse(Call<List<Refri>> call, Response<List<Refri>> response) {
            ...
            @Override
            public void onFailure(Call<List<Refri>> call, Throwable t) {
    ...
    public void updateLove(final String key, final int id, final Boolean love){
        ...
        Call<Refri> call = apiInterface.updateLove(key, id, love);
        ...
        call.enqueue(new Callback<Refri>() {
            ...
            public void onResponse(Call<Refri> call, Response<Refri> response) {
                ...
                if (value.equals("1")){
                    ...
                    Toast.makeText(MainActivity.this, "se quito", Toast.LENGTH_SHORT).show();
                }
