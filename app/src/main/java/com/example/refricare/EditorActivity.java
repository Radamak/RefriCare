...
public class EditorActivity extends AppCompatActivity {
    ...
    private void setDataFromIntentExtra() {
        ...
        if (id != 0) {
            ...
            getSupportActionBar().setTitle("Agregar tu Refri");
        }
    }
        ...
        mGenderSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.tipo_automatico))) {
                        mGender = AUTOMATICO;
                    } else if (selection.equals(getString(R.string.semi))) {
                        mGender = SEMI;
                    } else {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_save:
                ...
                if (id == 0) {
                    ...
                    if (TextUtils.isEmpty(mName.getText().toString()) ||
                        ...
                        alertDialog.setMessage("¡Por favor complete los campos!");
            ...
            case R.id.menu_delete:
                ...
                dialog.setMessage("¿Eliminar este Refri?");
    ...
    private void postData(final String key) {
        ...
        Call<Refri> call = apiInterface.insertPet(key, name, species, breed, gender, birth, picture);

        call.enqueue(new Callback<Refri>() {
            @Override
            public void onResponse(Call<Refri> call, Response<Refri> response) {
            ...
            @Override
            public void onFailure(Call<Refri> call, Throwable t) {
                progressDialog.dismiss();
    ...
    private void updateData(final String key, final int id) {
        ...
        Call<Refri> call = apiInterface.updatePet(key, id,name, species, breed, gender, birth, picture);
    ...
    private void deleteData(final String key, final int id, final String pic) {
        ...
        Call<Refri> call = apiInterface.deletePet(key, id, pic);
        ...
        call.enqueue(new Callback<Refri>() {
            ...
            public void onResponse(Call<Refri> call, Response<Refri> response) {
                ...
                if (value.equals("1")){
                    Toast.makeText(EditorActivity.this, "favorito", Toast.LENGTH_SHORT).show();
                    finish();
                } else {
                    Toast.makeText(EditorActivity.this, message, Toast.LENGTH_SHORT).show();
                }
